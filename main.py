...
# === Toutes les questions Oui/Non pour le quiz (20 Yes, 20 No) ===
quiz_questions = [
    # 20 questions "Yes"
...
# === Données pour quests et battles ===
...
async def slash_quiz(interaction: discord.Interaction):
    ...
    try:
        ...
        response = m.content.lower().strip()
        if response == q["answer"].lower():
